...
class Form extends Component {
  ...
  render() {
    ...
    return (
      <form onSubmit={this.handleSubmit} className="NewTodoForm" autoComplete="off">
        ...
        <label htmlFor="agree" className="confirm">
          <input onChange={this.inputHeandler} type="checkbox" id="agree" name="agree" checked={agree} />
